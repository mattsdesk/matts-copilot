...
- **APA structure:** $380K funded via SBLOC (Section 8.1 contingent on securing full $380K). Primary printer: Angle Printing and Publishing Company (no written contract). Postal permit Lancaster PA #1325 belongs to Joe -- likely non-transferable, Matt needs his own. David checking with printer contact Brian. Tax allocation (Form 8594 class 4/5/6/7) left blank; Matt to consult accountant before negotiating. LLC not yet formed; David will insert name once created. Promissory note (seller financing) is Mitch's paper, separate from APA, signed at closing.
...
- Updated `analysis/diligence-questions.md` with concrete asks for phone cutover, payment processing/PCI, APA asset schedules, Angle/color-insert/USPS permit continuity, GoDaddy/Constant Contact/QuickBooks transfer checklist, closing readiness, and entity/insurance coverage.
