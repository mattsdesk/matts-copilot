...
- 2026-07-21 -- Granola notes sync: 1 new meeting routed to Renna Media (2 pulled this run, 1 routed to Personal). Closing logistics call with David (attorney) and Brian: outstanding items on the closing statement (prepaid advertising, $60K seller note, AR adjustments); promissory note and current payoff letters still needed from Mitch; wire target Monday July 27 (SBLOC to personal bank to Prospect Local Media Chase account to David's firm); NJ incorporation doc (with state seal) needed by David in lieu of certificate of good standing; Joe's domain has a typo, Matt to buy the correct spelling; printer and post office transition on track; David recommended Jim Mooney (print/mail specialist) as a networking contact. [Meeting notes](meetings/2026/2026-07-21-closing-logistics-final-details-david.md)

- 2026-07-20 -- Granola diligence sync: reviewed four new July 15-17 notes. Preserved buyer-side context in `analysis/diligence-source-notes-2026-07-20.md`. Updated the integrated tracker for (1) complete production onboarding and tested FTP/order workflow, (2) a new buyer USPS permit, CRID, EPS, imprint approval, and first-issue contingency, (3) a complete readable seller QuickBooks export plus cutoff/opening-balance bridge into the clean buyer file, and (4) correction and cross-system verification of the `Grana Media` versus `Renna Media` DBA conflict. Kept the July 17 note's apparent `Engel Publishing` target misdescription explicit and unverified.

- 2026-07-14 -- Granola diligence sync: reviewed four new July 7-10 Renna meetings. Preserved buyer-side context in `analysis/diligence-source-notes-2026-07-14.md`. Updated the integrated tracker for (1) vendor legal-name verification and direct printer documentation, (2) stale carrier-route data, Doodad specifications/turnaround, and postal-permit bridge planning, (3) actual UCC/lien/judgment search results and releases before close, and (4) a calendarized transition cadence that reconciles Joe's daily-collaboration expectation with buyer capacity. Syndicated-content discussions were treated as post-close product context, not seller evidence.

- 2026-06-22 -- Granola diligence sync: reviewed newly added June 16-18 meeting notes against the integrated diligence tracker. Preserved new buyer-side context in `analysis/diligence-source-notes-2026-06-22.md`. Tightened `analysis/diligence-questions.md` around: (1) obtaining the seller's accrual reconstruction workbook plus specific missing postage support months (Feb/Mar/Nov 2025, May 2026) and updated 2026 monthly financials, (2) role-by-role day-one support for collections/bookkeeping/production, (3) hard-drive archive scope and transfer method, and (4) annual-billing concentration / renewal timing within top accounts. Financing notes from June 17-18 were retained only as close-risk context, not target-business evidence.
...
- 2026-06-18 -- Granola sync: 1 new meeting. Securities-backed line of credit call with Nick Almond. Leader Bank preferred over US Bank (soft pull vs hard pull, no meaningful rate difference). Plan: pledge managed account (8415) and individual account (278) to access $1M+ tier (~6% rate). Application link coming via email; ~10-15 min, approval in a few business days to a week. [Meeting notes](meetings/2026/2026-06-18-securities-backed-line-of-credit-nick-almond.md)

- 2026-06-17 -- Granola sync: 2 new meetings. (1) David Bohlander call: Huntington declined SBA loan citing "credit elsewhere" rule (Matt's retirement/college assets made him technically strong enough to fund conventionally). David will loop Cheryl in with other SBA lenders; HELOC now the primary fallback (21-30 day timeline); SBA line of credit also on the table. David considering leaving Huntington. [Meeting notes](meetings/2026/2026-06-17-david-bohlander-sba-decline.md) (2) Renna Media Monthly Meetup (Matt, Joe, Cheryl, Eric): Accrual P&L reconstruction uploaded to data room; missing postage receipts for Feb/Mar/Nov 2025 and May 2026 -- Joe to re-check. SBA exception still pending (underwriter flagged earmarked assets). APA draft in progress; Cheryl to notify Mitch (Joe's lawyer) to expect draft from Matt's counsel. Securities-backed lending (borrow ~75% of portfolio at prime minus 1.5-2%) flagged as additional fallback by Eric. July early meeting planned with Joe to build business/marketing plan. Next call: June 23, 11am. [Meeting notes](meetings/2026/2026-06-17-renna-media-monthly-meetup.md)

- 2026-06-16 -- Cheryl/Matt financing and diligence call. Financing update: David (bank) still non-responsive to calls and email; underwriter needs clarification on earmarked vs. available cash (college + retirement accounts). Realistic close pushed to end of August. HELOC flagged as fallback (potentially faster/better rates). Financial analysis passed: expense lines reconcile closely ($810K vs. Joe's $809K cash P&L; 3 months of postage receipts estimated at ~$38.5K each); ~$20-40K revenue gap vs. billings explained by 24-into-25 prepay offsets and 6 new papers at both ends -- likely translation artifact, not a real problem. Purchase agreement received but still references optometry clinic throughout; Matt's wife marking it up, target return by end of week. Cheryl demoed Reference Solutions (free via NJ library card / NJ Clicks): searchable business database, 100-record download limit, useful for cold-call prospect lists pre-activation. Next: upload accrual expense lines to data room; request 3 missing postage billing months from Joe; return marked-up APA; tomorrow's call with Joe covers diligence comfort + outstanding items + digital archive categories. [Meeting notes](meetings/2026/2026-06-16-cheryl-matt-financing-diligence.md)
...
### 2026-06-10 (granola-notes-sync)

- Granola sync: 1 new meeting (36 pulled from last 30 days, 35 already on disk).
- **2026-06-09-matt-cheryl-due-diligence-review.md:** Cheryl and Matt reviewed DD findings. Financial P&L close enough - no red flags, discrepancies feel like sloppiness not fraud. Key issues to raise on tomorrow's call with Joe: AR aging contradicts stated credit policy; prepaid report has formula errors (corrected figure ~$72K vs Joe's $66K PDF); postage figures off $3K across files ($41K Cheryl vs $38K Joe). Credit card transition risk flagged: customers must re-authorize under new entity (Sandra to advise). Commitment letter from David Bohlander expected end of week; master advertiser spreadsheet released post-letter. Prepaid settles via settlement sheet at closing (reduces Matt cash-in). Action: call David this afternoon, drop retainer at David Holdes' office this week.
- Updated `people/cheryl-venezia.md`.
...
### 2026-06-11 (granola-notes-sync)

- Granola sync: 1 new meeting (36 pulled from last 30 days, 1 routed to Personal, rest already on disk).
- **2026-06-10-renna-media-check-in.md:** First weekly Wednesday check-in with Joe, Cheryl, Eric. Diligence positive, no red flags. Bank package with underwriter; credit pulled; verbal commitment expected next week, formal letter after. Target close window early August (60 days from submission), 90 days outer bound; align closing with post-print cutover after August issue. Revenue reconstruction: rebuild P&L on accrual basis using RM Ads master file plus pricing chart; prepaid tracker spreads prepay across 7 months (1 free); master annual file is clean source. April postage discrepancy ($38,389 Joe vs $41,113.49 Cheryl invoices) likely summary-sheet data entry error; Joe checking. Scope agreed: Engle printing invoices and postage reports from Jan 2025 forward (2024 offered). Fixed assets: 2 computers + scanner. No leases, no marketing spend, zero-percent loans stay with Joe. APA will need digital asset exhibit; Matt to devise capture method. RM Ads master file sharing pending Joe/Eric discussion; marketing plan and transition planning deferred to post-commitment.
- Updated `people/cheryl-venezia.md`.

### 2026-06-12 (granola-notes-sync)

- Granola sync: 2 new meetings, both routed here. 1 empty "New note" (Jun 1) skipped.
- **2026-06-12-joe-revenue-accounting-ad-pricing.md:** Joe decoded RM Ads spreadsheet notation (IN inserts, PR press releases, X filler standby, paid page placement with first right of refusal, BC back cover, MG make goods, EX nonprofit extras). Revenue model: split monthly revenue proportionally across 30 papers; small towns highly profitable (Garwood $667 cost), large towns near break-even (Linden ~$5K); regional advertisers carry the network. Montclair cluster (Cedar Grove, Glen Ridge, Montclair, Verona) flagged as natural next expansion. Joe open to Matt selling ads pre-close at 50/50 split; target one large account per month (~$20K/yr), high-ROI targets like Kessler and Summit Medical over small brick-and-mortar. Next: finish revenue spreadsheet, build target list together, Joe to make co-branded rate sheet, lunch after bank approval.
- **2026-06-12-sba-liquidity-requirement.md:** Lender call on SBA "credit elsewhere" rule. Matt's liquid assets ~3x loan amount triggered the rule (rule is now lender discretion). Funds: two Fidelity managed funds (larger tied to retirement, smaller maturing ~8 yrs for oldest child's college), two 529s, 85-90% equities. Lender views risk as near zero, will push back internally and follow up; financial advisor can document retirement intent if needed.

### 2026-06-15 (granola-folder-diligence-sync)

- Reviewed files changed since the last diligence sync run on 2026-06-08 13:01 UTC. New Renna-relevant meeting context came from June 9, June 10, and June 12 Granola notes; Cheryl person-file updates did not add separate diligence facts beyond those meetings.
- Preserved unverified buyer-side diligence context in `analysis/diligence-source-notes-2026-06-15.md`. Carried forward: AR aging vs stated credit policy mismatch, prepaid workbook/formula issues and closing-settlement impact, agreed delivery of raw Engle printing and postage support from Jan 2025 forward, digital asset workbook existence but unresolved transfer mechanics, RM Ads notation/data-dictionary needs, regional-advertiser subsidy thesis, and financing-close risk from the SBA liquidity rule.
- Updated `analysis/diligence-questions.md` integrated tracker. Existing asks were tightened for RM Ads export scope, digital asset transfer proof, Wells Fargo/PCI handling, raw postage support, and fixed-asset scheduling. Added new concrete asks for AR aging reconciliation plus April-May 2026 GLs, corrected prepaid liability schedule and settlement treatment, and company formation/governance records.
- No seller-verified evidence was added in this pass. Meeting notes remain context only until supported by exports, invoices, formation docs, contracts, statements, or other third-party records.

### 2026-06-22 (granola-folder-diligence-sync, second pass)

- Re-checked Renna meeting notes, Cheryl context, and diligence analysis files after the earlier 2026-06-22 sync run.
- Found no new or modified Renna-relevant source files since the prior run timestamp (`2026-06-22 09:01:34 EDT`), so `analysis/diligence-source-notes-2026-06-22.md` and `analysis/diligence-questions.md` remain current.
- Confirmed that recent financing notes remain closing-risk context only and that no additional seller-verified evidence was added in this pass.

### 2026-06-29 (granola-notes-sync)

- Granola sync: 6 new meetings routed to Renna Media (Jun 22-23). Key developments:
- **New entity confirmed:** Prospect Local Media LLC, 243 Valley Road Montclair NJ 07042, EIN 42-3327614, DBA Renna Media. Ownership: Sandra Saunders 51%, Matt 49%. [Insurance meeting](meetings/2026/2026-06-23-prospect-local-media-business-insurance.md)
- **Target close: July 28, 2026.** APA must be signed by July 13 for bulk sale filing (10 business days). Week of July 27 is the natural close window (Joe to printer July 26, distribution July 30). [Renna Media Touchpoint](meetings/2026/2026-06-23-renna-media-touchpoint.md)
- **Financing: SBLOC replacing SBA.** SBA declined (liquidity-multiple clause). Securities-backed line of credit via Nick Almond (Leader Bank) in application; approval expected within days as of June 23. Financing risk flagged as zero. [APA Review](meetings/2026/2026-06-22-apa-review.md)
- **APA structure:** $380K funded via SBLOC (Section 8.1 contingent on securing full $380K). Primary printer: Engle Printing and Publishing Company (no written contract). Postal permit Lancaster PA #1325 belongs to Joe -- likely non-transferable, Matt needs his own. David checking with printer contact Brian. Tax allocation (Form 8594 class 4/5/6/7) left blank; Matt to consult accountant before negotiating. LLC not yet formed; David will insert name once created. Promissory note (seller financing) is Mitch's paper, separate from APA, signed at closing.
- **Transition details from June 23 touchpoint:** Joe back from vacation July 6; onboarding starts then, Matt to shadow Joe on July issue. August edition (press July 26) will announce ownership transition and new contact details. GoDaddy and Constant Contact to transfer; QuickBooks likely transferable (Joe to confirm). Matt may need to re-confirm CC details with each advertiser for new entity.
- **Website redesign (June 22 chat with Varad):** Core diagnosis -- too much text (cut 50-60%), no visual variety, AI subheadings everywhere. Three-section homepage: (1) best way to reach local customers, (2) cheapest option, (3) done-for-you. Pricing page to show reach first, then size, then live price. About page = legitimacy page (1998 founding, logos, advertiser count, gallery). [Website meeting](meetings/2026/2026-06-22-varad-chat-website-redesign.md)
- **Credit card processing (June 23, with Steve):** ~75-100 transactions/month, $75-100K/month. Steve (Mountain Lakes NJ, ~19 yrs) recommended over QuickBooks gateway (closed system, 3.5-4% virtual rate). Dual pricing model (fee to cardholder) used by ~90% of his clients. Setup needs driver's license, SS-4, and non-starter business checking account. Can follow close by 1-2 months. [CC meeting](meetings/2026/2026-06-23-credit-card-processing-setup.md)
- **Business insurance (June 23, with Stephanie):** Quotes expected by June 26. Business personal property ~$1K (minimal). Workers comp not required as LLC; required upon S-corp conversion (Sandra excluded if no payroll). [Insurance meeting](meetings/2026/2026-06-23-prospect-local-media-business-insurance.md)
- **Homepage redesign session (June 23):** Masthead: "Reach every mailbox in your town." CTA: "Get Started" + "See Our Publications." Feature box text stripped to 3 bullets. [Meeting notes](meetings/2026/2026-06-23-evaluation-intake-and-website-homepage-redesign.md)

### 2026-07-06 (granola-folder-diligence-sync)

- Reviewed June 22-23 Renna Granola notes against the due diligence source imports and integrated open questions tracker.
- Preserved new buyer-side diligence context in `analysis/diligence-source-notes-2026-07-06.md`. Key topics: APA asset schedules, printer/postal permit continuity, new-number/call-forwarding plan, account/software transfer, payment processing reauthorization, late-July closing critical path, buyer entity/insurance, and website redesign as commercialization context only.
- Updated `analysis/diligence-questions.md` with concrete asks for phone cutover, payment processing/PCI, APA asset schedules, Engle/color-insert/USPS permit continuity, GoDaddy/Constant Contact/QuickBooks transfer checklist, closing readiness, and entity/insurance coverage.
- Verified the central Dropbox workpaper mirror already exists in `Due Diligence Documents/Analysis/Analysis Workpapers`: July 6 source imports were preserved and the integrated tracker was updated there at 09:03 EDT.

### 2026-07-07

- **APA nearing execution; signature timeline has an open ambiguity.** David Foltz (Buttermore & Foltz) sent back the near-final APA the evening of 7/6, calling it "strong" with only a few changes from Joe's side; once signed, counsel files for bulk sale approval, and Mitch (Joe's attorney, Mitchell Beinhaker) sets up signature after David approves. Sandra reviewed same night and flagged: (1) confirm counsel has provided the draft promissory note, bill of sale, and schedules -- not yet confirmed; (2) closing date should read July 28; (3) Section 4.5 typo ("affection" should be "affecting"). **Open issue Matt flagged and still needs resolved with Joe/counsel:** the transition start date is tied to "when both parties sign," but Joe told Eric the same day "I signed the APA" -- Matt does not believe that can be accurate since Matt's side has not executed yet. Needs clarity before the transition clock (shadowing Joe/Tina on the August issue) is treated as started. Matt has since followed up with his lawyers on these details.
- Eric separately asked (7/6) whether Joe -- and by extension Matt -- can get on a call Thursday 7/9 once Joe is caught up from vacation. Not yet confirmed.
- **New business lead: Andrews McMeel Syndication.** John Schneider (Syndication Sales Manager, Andrews McMeel/Universal, 203-993-0915, jschneider@amuniversal.com) emailed 7/7 asking for a callback re: puzzles, comics, and columns content, following an outbound email from Matt. Matt spoke with him by phone same day (7/7). Call is now captured via Granola sync (see below).

### 2026-07-09

- Built `deliverables/Renna-Media-APA-Schedules.docx`: shell for all 12 APA schedules (1.2c, 1.2e, 1.2g, 1.3d, 1.4a, 1.5a, 1.5b, 3.1d, 4.6, 4.7, 4.10, 4.17b), each on its own page. Pre-filled from project records where solid (trade names list of 30 papers, 4.17b town/ZIP/county table, 1.4a "None" per Matt, 1.5b prepaid figures with the $66K vs $72K discrepancy). Left explicit "needed" call-outs where a real seller export is required (1.2g customer list, 1.2c full domain/social inventory, 1.3d personal property, 1.5a AR aging, 3.1d USDA/EDA loan list, 4.10 actual financials). Flagged one open discrepancy: source notes tie APA Section 4.6 to an employment-contract rep, not litigation — worth confirming against the executed draft. Next: fill in schedules one-by-one with Matt.

### 2026-07-07 (granola-notes-sync)

- Granola sync: 1 new meeting routed to Renna Media (24 pulled from last 30 days, 22 already on disk, 1 routed to Personal).
- **2026-07-07-syndicated-content-licensing-andrews-mcneil.md:** Call with John (18 years at Andrews McNeil, ex-VP Advertising and Marketing, managed ~35 weeklies previously). Covers Matt's 30-title NJ network (Union/Morris/Essex/Somerset, saturation mail, 2K-17K homes per town, hyperlocal good-news focus). Monthly titles would be billed for one week per month vs. four for weeklies/dailies; rates described as low. Possible overlap with existing NJ daily/weekly syndication clients (e.g. Garfield strip) -- John to check whether monthly frequency sidesteps exclusivity. Next: review Andrews McNeil catalog (sent same afternoon) and follow up with John by Thursday July 9 on fit and title carve-out. [Meeting notes](meetings/2026/2026-07-07-syndicated-content-licensing-andrews-mcneil.md)

### 2026-07-09 (granola-notes-sync)

- Granola sync: 2 new meetings, both routed to Renna Media (25 pulled from last 30 days, 23 already on disk).
- **2026-07-09-apa-execution-printer-setup-with-jo.md:** Five hours shadowing Joe on production yesterday, more today. Printer relationship still informal (no written contract). APA was missing schedules; Matt generated and sent to David. Open item: confirm David completed the UCC lien search before signing -- bulk closing can't proceed without a signed APA. Unclear whether the $500 judgment search falls under the flat-fee retainer or is a billable extra. Joe wants daily collaboration for the next two months; Matt flagged that's not fully realistic given other commitments. Target: APA fully executed today or first thing tomorrow (July 10). [Meeting notes](meetings/2026/2026-07-09-apa-execution-printer-setup-with-jo.md)
- **2026-07-09-rennamedia-transition-printing-mailing-postal-with-jeremy.md:** Intro call with Jeremy, VP of Operations at Angle Printing and Publishing (family-run, founded 1959, Mountjoy PA; Joe is a top-8 customer by volume, no formal contract, month-to-month). Confirms production rhythm: page count Sunday evening, file upload Sunday night into Monday, 30 editions; annual schedule set each Nov/Dec with a February exception for the real estate awards issue. Paper stock mostly 30 lb newsprint, market has been volatile ~9 months, Jeremy commits to 1 month's notice on price changes. Mailing is full saturation by zip, ~35 post offices across 30 editions via DDU entry; carrier route list hasn't been updated in ~2 years. Color confirmed as a clear opportunity (Joe has run black-and-white by choice). Action items: get pricing guide/paper samples direct from Jeremy (via rep Jeff Cryer), get file spec sheet and sample files from Angle, set up Matt's own postal permit with mailing manager Mark Malloy (Angle's Lancaster PA permit is not ideal to inherit), shadow Joe on the August edition (upload ~July 26) before owning the September edition solo, and plan a plant site visit. [Meeting notes](meetings/2026/2026-07-09-rennamedia-transition-printing-mailing-postal-with-jeremy.md)

### 2026-07-10 (granola-notes-sync)

- Granola sync: 1 new meeting routed to Renna Media (25 pulled from last 30 days, 24 already on disk).
- **2026-07-10-call-with-debbie-doodad-operations-transition.md:** Intro call with Debbie at Doodad, a Lancaster PA half-web printer (~22-23 years there, retiring in ~2 years). Doodad runs newspaper inserts (~30% of its mix) and menus via brokers (~70%), and works jobs back and forth with Angle. Joe's Doodad volume: ~$15K last year, ~$6K YTD, described as a small side relationship; Matt's goal is to grow it. Matt takes over from Joe at end of July; Joe covers the August run (insert deadline next week), swap happens once the current month clears through Angle. Call connection was bad and dropped mid-conversation (Matt briefly reached Doodad's main line by mistake); some turnaround-time and spec details were lost. [Meeting notes](meetings/2026/2026-07-10-call-with-debbie-doodad-operations-transition.md)

### 2026-07-15 (granola-notes-sync)

- Granola sync: 2 new meetings, both routed to Renna Media (22 pulled from last 30 days, 20 already on disk).
- **2026-07-15-print-production-handoff-supplier.md:** Joe stays primary printer contact through the current edition (Friday deadline); Matt takes over as primary and billing contact starting with the September edition. Submission specs: PDF, CMYK, 8.5x11, two-sided as a two-page PDF, 4-5 day turnaround via FTP upload; order forms go to Cindy and Anita. Open items: confirm FTP credentials, get pricing grid and onboarding package from Joe. [Meeting notes](meetings/2026/2026-07-15-print-production-handoff-supplier.md)
- **2026-07-15-quickbooks-setup-bank-linking.md:** QuickBooks set up with Matthew DePeri (Hoogstra CPA) for the new acquisition entity, **DBA entered as "Grana Media"** -- flag and confirm this against the entity's actual DBA of record ("Renna Media" per the June 23 insurance/entity meeting; Prospect Local Media LLC, EIN 42-3327614). Cash-basis accounting, ~30% of profit set aside for estimated taxes. S corp election needs to be filed within 3 months of formation (send formation docs to Matthew ASAP); reasonable salary rule of thumb ~50% of projected profit, rest as K-1 distributions; payroll setup can be delayed a few months. First bank reconciliation expected around August 1. [Meeting notes](meetings/2026/2026-07-15-quickbooks-setup-bank-linking.md)

### 2026-07-17 (granola-notes-sync)

- Granola sync: 2 new meetings, both routed to Renna Media (22 pulled from last 30 days, 20 already on disk).
- **2026-07-17-usps-permit-setup-newspaper-distribution.md:** Call covering the buyer's own USPS bulk-mail permit (asset sale means nothing carries over from Joe's Lancaster permit #1325). Needs a Business Customer Gateway account (generates a new CRID), an Enterprise Payment Account, and PS Form 3615 ($390 annual permit fee, $390 annual renewal). Recommended next step: in-person visit to the Business Mail Entry Unit at 155 Clinton Road, Caldwell NJ, bringing a prior postage statement. [Meeting notes](meetings/2026/2026-07-17-usps-permit-setup-newspaper-distribution.md)
- **2026-07-17-engel-publishing-marketing-mail-permit.md:** Companion call on the marketing-mail permit needed for the Engel Publishing side of the printing/mailing relationship (asset acquisition from Jeremy Engel; existing permit can't transfer). $390 one-time application fee via MSSC (877-672-0007); can pay online or have MSSC open the account directly. Permit imprint number must appear on all mailed pieces once issued -- needs to go to Engel once received. [Meeting notes](meetings/2026/2026-07-17-engel-publishing-marketing-mail-permit.md)
- Both meetings are the postal-permit thread that continues from the July 9 Angle/Jeremy transition call (Angle's Lancaster PA permit flagged there as not ideal to inherit).
