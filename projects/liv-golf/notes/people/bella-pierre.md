...
Bella is a design and brand leader responsible for visual content, imagery, branding consistency, and event badging implementation. She jumped into the fantasy project wholeheartedly and manages brand asset updates across digital properties. She interfaces with content teams on imagery requirements, player photography, and event-specific branding (colors, badges, logos). Her work spans the mobile app, website, and fantasy game interfaces.

## Key Themes

- **Brand consistency enforcement** — Manages "LIV Golf" naming standards, event badging, and circular badge implementation across digital properties
