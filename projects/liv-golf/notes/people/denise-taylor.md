...
Denise is the operational backbone of LIV Golf's digital transformation. Over ~18 months, she's overseen a complete platform rebuild, expanded the team from zero to full technical staff, and shifted the company from answering "absurd questions" to being trusted strategic advisors. She drives execution on web launches, capital budgeting, vendor contracts, and leadership alignment across commercial and technical teams.

## Key Themes

- **Escalating deadline pressure** — "This date is not going past here" (May 4, DC/Virginia). Board-level scrutiny on 6-week delay. Calling the extended timeline "unacceptably late" — pushing for earlier launch windows (Michigan/Virginia vs Mexico soft launch). Prefers visual/pictorial presentations over text-heavy decks
- **Vendor management** — Strong negotiator but demanding; escalates when contracts or SLAs aren't met. Manages payment terms, contract reviews, and quality thresholds
- **Foundation completion mentality** — Currently focused on finishing the digital platform rebuild. Website and fantasy features are key milestones
- **Team retention & transition** — Departure timeline clarified: months not weeks; must finish commercial deals (including Delta Tray termination, vendor decisions) before transitioning; going to CEO #2 role at her previous company
- **Cross-functional alignment** — Expects clear communication channels, single points of contact, and escalation structures. Dislikes information silos
...
| Date | Meeting | Notes |
|------|---------|-------|
| 2026-01-21 | [Quick Sync w/ Denise and Team](../meetings/2026/2026-01-21-quick-sync-denise-and-team.md) | CRM repositioning, Fantasy branding, APEX launch readiness |
| 2026-02-05 | [Denise Ops Huddle Up](../meetings/2026/2026-02-05-denise-ops-huddle-up.md) | Critical platform issues (leaderboard lag, landscape video, events tab lock), escalations |
| 2026-03-09 | [Web Timeline Meeting w/ Denise](../meetings/2026/2026-03-09-web-timeline-meeting-denise.md) | Website launch delay to May 4th, technical justification |
