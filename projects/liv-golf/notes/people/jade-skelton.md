...
Jade is an operations and process lead responsible for cross-functional coordination, project management, and process improvements. She works with Lewis and the product team on visibility gaps and process structure. Jade is involved in addressing communication gaps between product verticals and implementing better process discipline.

## Key Themes

- **Process improvement** — Implementing daily standups, elaboration sessions, and formal JIRA processes
...
### 2026-03-18 — Jade Conversation about Email

Called out for sending a process framework email to Denise (cc Katherine, Matt) without prior alignment. Created risk of looking disorganised to leadership. Jade's stated goal is to build a comprehensive team process framework with value streams, pillars, and sprint structures — similar to what she did before she says she was asked to stop. Matt's pushback: the mission is clear (rebuild app and website), clear owners already exist (Arthur: streaming, Lewis: web/content), and prioritisation doesn't require a formal KPI structure from executives first. Team clarity perception gap surfaced — Jade says team is unclear on responsibilities; Matt's read from recent conversations with Lewis and Arthur doesn't match. Directed Jade to have follow-up conversations with both. Denise departure now announced at Chris Heck all-hands. Fantasy vendor departing in ~8 weeks; warned about new engineers wanting to rewrite inherited code.
...
| 2026-03-13 | [Katherine / Matt Catch Up & Nick/Jesse Catch Up](../meetings/2026/2026-03-13-katherine-matt-catch-up.md) | Performance concerns discussed between Matt and Katherine; HR escalation planned; March 18 meeting |
| 2026-03-10 | [Huddle with Lewis & Jade](../meetings/2026/2026-03-10-huddle-lewis-jade.md) | Fantasy process breakdown, required process changes, escalation strategy |
