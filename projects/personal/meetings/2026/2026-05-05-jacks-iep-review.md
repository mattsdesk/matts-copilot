# Jack's annual IEP review for middle school transition

**Date:** May 5, 2026
**Attendees:** School staff (RC counselor, Miss Quinn teacher), parents
**Context:** Personal
**Source:** Granola, meeting ID `ef1e7bf8-212d-40e3-b508-d91bd797d214`

---

## Jack's Current Progress & Strengths

- Counseling performance (RC)
  - Excels in small group sessions with one other student
...
- Academic performance (Miss Quinn)
...
- Writing challenges
  ...
  - Interprets instructions extremely literally (wrote 4-paragraph essay when 5 required because instructions didn't specify)
...
- Documentation
  - Draft IEP to be sent for parent review
  - Copy of last year's final IEP to be provided
  - Teacher write-ups included from all service providers
